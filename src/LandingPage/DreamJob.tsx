        ...
        <div className="flex items-center px-16">
           ...
           <div className="w-[55%] flex items-center justify-center">
            <div className="w-[30rem] relative"> 
                ...
                <div className=" absolute -right-5 w-fit top-[50%] border-bright-sun-400 border rounded-lg p-2 backdrop-blur-md gap-3 flex-col">
                ...
                <div className="absolute -left-10 w-fit top-[28%] border-bright-sun-400 border rounded-lg p-2 backdrop-blur-md">
                    <div className="flex gap-2 justify-around items-center ">
                        ...
                        <div className="text-sm text-mine-shaft-100">
                            ...
                            <div className="text -mine-shaft-200 text-xs">Ujjain</div>
                        </div>
                    </div>
